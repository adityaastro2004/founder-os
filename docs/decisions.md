...
- Date: 2026-07-18
- Status: accepted (retroactive record — implementation already in the working tree
  on `security/harden-web-api`; formalized and shipped via task 017's dedicated PR)
...
- Links: `founder-os/apps/api/app/agents/base.py` (`run()` step 3,
  ...
  `Message.tool_use_id`),
  [tasks/active/017](../tasks/active/017-agent-history-replay-fix-guardrails.md),
