"""
Alembic env.py — Sync configuration for Founder OS migrations.
"""
...
# ---------------------------------------------------------------------------
# Import models so Base.metadata reflects the full schema
# ---------------------------------------------------------------------------
...
# Override sqlalchemy.url with the sync driver for Alembic
